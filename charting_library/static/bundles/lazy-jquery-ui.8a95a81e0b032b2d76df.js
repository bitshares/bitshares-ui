                ...
                $.extend(Datepicker.prototype, {
                        ...
                        (s = e || {}),
                            ...
                            a &&
                                ...
                                null !== o &&
                                    ...
                                    s.minDate === undefined &&
                                    (a.settings.minDate = this._formatDate(
                                        a,
                                        o
                                    )),
                                null !== r &&
                                    s.dateFormat !== undefined &&
                                    s.maxDate === undefined &&
                                    (a.settings.maxDate = this._formatDate(
                                        a,
                                        r
                                    )),
                    ...
                    _doKeyPress: function(t) {
                        ...
                        if ($.datepicker._get(s, "constrainInput"))
                            return (
                                (e = $.datepicker._possibleChars(
                                    $.datepicker._get(s, "dateFormat")
                                )),
                                (i = String.fromCharCode(
                                    t.charCode == undefined
                                        ? t.keyCode
                                        : t.charCode
                                )),
                                t.ctrlKey ||
                    ...
                    _showDatepicker: function(t) {
                        ...
                        (t = t.target || t),
                            ...
                            $.datepicker._isDisabledDatepicker(t) ||
                                ...
                                $.datepicker._pos ||
                                    (($.datepicker._pos = $.datepicker._findPos(
                                        t
                                    )),
                        ...
                        t.dpDiv.empty().append(this._generateHTML(t)),
                            ...
                            s > 1
                                ...
                                : t.dpDiv
                                      ...
                                      .width(""),
                            t.dpDiv[
                                (1 != i[0] || 1 != i[1] ? "add" : "remove") +
                                    "Class"
                            ]("ui-datepicker-multi"),
                            t.dpDiv[
                                (this._get(t, "isRTL") ? "add" : "remove") +
                                    "Class"
                            ]("ui-datepicker-rtl"),
                    ...
                    _checkExternalClick: function(t) {
                        if ($.datepicker._curInst) {
                            ...
                            e[0].id == $.datepicker._mainDivId ||
                                0 !=
                                    e.parents("#" + $.datepicker._mainDivId)
                                        .length ||
                        ...
                        for (
                            s =
                                ...
                                f = function(t) {
                                    ...
                                    if (!o)
                                        throw "Missing number at position " + _;
                                    return (
                                        (_ += o[0].length), parseInt(o[0], 10)
                                    );
                                },
                                g = function(t, i, s) {
                                    var n,
                                    ...
                                    for (n = 0; n < o.length; n++)
                                        if (
                                            ...
                                            return (_ += o[n].length), n + 1;
                                    throw "Unknown name at position " + _;
                                },
                                m = function() {
                                    if (e.charAt(_) != t.charAt(v))
                        ...
                        if (
                            ...
                            for (
                                f = this._daylightSavingAdjust(
                                    ...
                                    f = c && f < c ? c : f;
                                this._daylightSavingAdjust(new Date(u, d, 1)) >
                                f;
                          ...
                          "string" == typeof arguments[1]
                            ...
                            : this.each(function() {
                                  "string" == typeof t
                                      ? $.datepicker[
                                            "_" + t + "Datepicker"
                                        ].apply($.datepicker, [this].concat(e))
        ...
        !(function(t, e) {
            t.widget("ui.draggable", t.ui.mouse, {
                ...
                t.ui.plugin.add("draggable", "iframeFix", {
                    start: function(e, i) {
                        var s = t(this).data("draggable").options;
                        t(!0 === s.iframeFix ? "iframe" : s.iframeFix).each(
                            function() {
                                t(
            ...
            t.widget("ui.resizable", t.ui.mouse, {
                ...
                _mouseCapture: function(e) {
                    var i,
                        s = !1;
                    for (i in this.handles)
                        t(this.handles[i])[0] == e.target && (s = !0);
                        ...
                        this._helper &&
                            ...
                            (l =
                                parseInt(s.element.css("left"), 10) +
                                    (s.position.left -
                                        s.originalPosition.left) || null),
                            (c =
                                parseInt(s.element.css("top"), 10) +
                                    (s.position.top - s.originalPosition.top) ||
                                null),
                            i.animate ||
                                this.element.css(
                                    t.extend(h, {top: c, left: l})
                                ),
                ...
                _updateRatio: function(t, e) {
                    ...
                    return (
                        t.height
                            ? (t.width = s.height * this.aspectRatio)
                            : t.width &&
                              (t.height = s.width / this.aspectRatio),
                        "sw" == n &&
                ...
                _proportionallyResize: function() {
                    ...
                    if (this._proportionallyResizeElements.length)
                        for (
                            e = this.helper || this.element, i = 0;
                        ...
                        var s = t(this).data("resizable"),
                            ...
                            o = function(e) {
                                t(e).each(function() {
                                    var e = t(this);
                                    e.css({
                                        position: e.data("resizable-alsoresize")
                                            .position
                                    });
                                });
                            };
                ...
                t.ui.plugin.add("resizable", "containment", {
                    start: function(e, s) {
                        var n,
                            ...
                            g =
                                f instanceof t
                                    ? f.get(0)
                                    : /parent/.test(f) ? u.parent().get(0) : f;
                        g &&
                    ...
                    resize: function(e, i) {
                        ...
                        u[0] != document && f && (d = l),
                            ...
                            (s = Math.abs(
                                (a._helper,
                                a.offset.left - d.left + a.sizeDiff.width)
                            )),
                            (n = Math.abs(
                                (a._helper
                                    ? a.offset.top - d.top
                                    : a.offset.top - l.top) + a.sizeDiff.height
                            )),
                            (o =
                            ...
                            s + a.size.width >= a.parentData.width &&
                                ((a.size.width = a.parentData.width - s),
                                p &&
                                    (a.size.height =
                ...
                t.ui.plugin.add("resizable", "ghost", {
                    ...
                    stop: function(e, i) {
                        ...
                        s.ghost &&
                            s.helper &&
                            s.helper.get(0).removeChild(s.ghost.get(0));
                    }
                }),
                t.ui.plugin.add("resizable", "grid", {
                    resize: function(e, i) {
                        ...
                        (r.grid =
                            "number" == typeof r.grid
                                ? [r.grid, r.grid]
                                : r.grid),
                            (s =
                                Math.round(
                                    (a.width - h.width) / (r.grid[0] || 1)
                                ) * (r.grid[0] || 1)),
                            (n =
                                Math.round(
                                    (a.height - h.height) / (r.grid[1] || 1)
                                ) * (r.grid[1] || 1)),
                            /^(se|s|e)$/.test(c)
            ...
            t.widget("ui.sortable", t.ui.mouse, {
                    ...
                    return (
                        ...
                        (!this.options.disabled &&
                            ...
                            t(e.target)
                                .parents()
                                .each(function() {
                                    if (t.data(this, "sortable-item") == n)
                                        return (s = t(this)), !1;
                                }),
                            t.data(e.target, "sortable-item") == n &&
                                (s = t(e.target)),
                            !!s &&
                                (!(
                                    this.options.handle &&
                ...
                _refreshItems: function(e) {
                    ...
                    for (o = s.length - 1; o >= 0; o--)
                        for (
                            l = s[o][1], c = s[o][0], a = 0, p = c.length;
                            a < p;
                            a++
                        )
                            (d = t(c[a])),
                ...
                _createPlaceholder: function(e) {
                    ...
                    (n.placeholder && n.placeholder.constructor != String) ||
                            ...
                            element: function() {
                                var e = t(
                                    document.createElement(
                                        s.currentItem[0].nodeName
                                    )
                                )
                                    .addClass(
                                        i ||
                                            s.currentItem[0].className +
                                                " ui-sortable-placeholder"
                                    )
                        ...
                        (s.placeholder = t(
                            n.placeholder.element.call(s.element, s.currentItem)
                        )),
                ...
                _cacheMargins: function() {
                    this.margins = {
                        left:
                            parseInt(this.currentItem.css("marginLeft"), 10) ||
                            0,
                        top:
                            parseInt(this.currentItem.css("marginTop"), 10) || 0
                    };
                },
                _cacheHelperProportions: function() {
                    this.helperProportions = {
