                ...
                (t = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype.componentWillUnmount = function() {
                            this._unsubscribe(),
                                u.OverlapManager.removeWindow(this._uuid);
                        }),
                            ...
                            return e.isOpened
                                ? (u.OverlapManager.registerWindow(this._uuid),
                                  s.createElement(
                                      ...
                                      r.__assign({}, e, {
                                          key: this._uuid,
                                          zIndex: u.OverlapManager.getZindex(
                                              this._uuid
                                          )
                                      }),
                                      e.children
                                  ))
                                : (u.OverlapManager.unregisterWindow(
                                      this._uuid
                                  ),
                                  null);
                        }),
        ...
        (function(e, o) {
                    ...
                    null != e &&
                        ...
                        u < i.length &&
                            ...
                            quoteSessionMultiplexerInstance.full.subscribe(
                                ...
                                function(t, n) {
                                    l(n.values, i),
                                        quoteSessionMultiplexerInstance.full.unsubscribe(
                                            c,
                                            e
                                        ),
                                        r(d);
            ...
            function r(e) {
                E ||
                    ...
                    C.render(D.createElement(L, e), E);
            }
            function s(e) {
                var t,
                    n = w;
            ...
            function l(e, t) {
                ...
                for (n = 0; n < t.length; n++)
                    (o = t[n].propName) in e &&
                        ...
                        !e.fractional &&
                        e.pricescale
                            ? ((t[n].value = new x(e.pricescale / i).format(
                                  i / e.pricescale
                              )),
            ...
            function d(e) {
                var t, n;
                return (
                    e > O.minutesPerDay && (e -= O.minutesPerDay),
                    (t = e % 60),
                    (n = (e - t) / 60),
                    P(n, 2) + ":" + P(t, 2)
                );
