            ...
            o(642),
                ...
                (r.prototype.createTreeNodeItem = function(t, e, o) {
                    ...
                    return (
                        ...
                        s.click(
                            this._onNodeToggleExpandCollapse.bind(this, s, t)
                        ),
                        (r = s
                            .find(".js-remove-btn")
                            .attr(
                ...
                (r.prototype.createItem = function(t, e) {
                    ...
                    return (
                        ...
                        o.userEditEnabled() &&
                            ...
                            r &&
                                this._setupEditAlertButton(
                                    s.find(".js-edit-alert-btn"),
                                    o
                                ),
                            this._setupFormatButton(
                                s.find(".js-format-btn"),
                                o
                            ),
                            this._canShowEditObjectDialog(o) &&
                                ...
                                e.addContextMenu &&
                                    s.on(
                                        "contextmenu",
                                        function(t) {
                                            this._showContextMenu(t, o),
                                                t.preventDefault();
                                        }.bind(this)
                                    )),
                            this._setupItemRemoveButton(
                                s.find(".js-remove-btn"),
                                o
                            )),
                        s
                    );
                ...
                (r.prototype._canShowEditObjectDialog = function(t) {
                    return (
                        ...
                        ((t !== this._chartModel.mainSeries() ||
                            ...
                            (_.hasStylesPropertyPage(t) ||
                                _.hasInputsPropertyPage(t)))
                    );
                }),
                ...
                (r.prototype._setupItemPropertyButton = function(
                    t,
                    e,
                    o,
                    i,
                    ...
                    if (((o = t[e]), o.children.length))
                        for (i = o.children.length - 1; i >= 0; --i)
                            (r = o.children[i]),
                                ...
                                0 !== s.length &&
                                    this._listAccessor().updateItem(s, r);
            }),
