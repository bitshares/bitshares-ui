webpackJsonp([5], {
    ...
    208: function(e, t, o) {
        ...
        var a = o(10),
            ...
            T = o(1121).createShapeLocationEditor,
            _ = o(1122).createShapeStyleEditor,
            m = o(15).createLineWidthEditor,
            f = o(1123).createVisibilityEditor,
            L = o(1119).createHHistDirectionEditor,
        ...
        inherit(i, r),
            (i.prototype.prepareLayout = function() {
                                        ...
                                        : this._study.isOHLCSeriesPlot(n)
                                            ? ((p = {id: r, type: "ohlc"}),
                                              this._study.isOHLCBarsPlot(n)
                                                  ? this._prepareLayoutForBarsPlot(
                                                        n,
                                                        p
                                                    )
                                                  : this._study.isOHLCCandlesPlot(
                                                        n
                                                    ) &&
                                                    this._prepareLayoutForCandlesPlot(
                                                        n,
                                                        p
                                                    ))
                                            : x.logError(
                                                  "Unknown plot type: " + l.type
                                              );
                    }
                    ...
                    for (n = 0; n < s.childCount(); n++)
                        (b = s[n]),
                            (b.isHidden && b.isHidden.value()) ||
                                ...
                                this.bindControl(O),
                                this.bindControl(
                                    new c(f, b.visible, !0, this.model(), W)
                                ),
                                this.bindControl(
                                    new u(B, b.color, !0, this.model(), W)
                                ),
                                this.bindControl(
                                    new h(
                                        I,
                                ...
                                this.bindControl(
                                    new C(R, b.linewidth, !0, this.model(), W)
                                ));
                if (
                    ...
                    for (n = 0; n < j.length; ++n)
                        (z = j[n]),
                            z.isHidden ||
                                ((W = "Change " + V),
                                (b = this._study.properties().filledAreasStyle[
                                    z.id
                                ]),
                ...
                (Y = this._table.find(
                    ".visibility-switch.plot-visibility-switch"
                )),
                    1 === Y.length &&
                        ((_ = Y.parent()),
                        _.css("display", "none"),
                        (v = this._table.find(
                            ".propertypage-plot-with-palette"
                        )),
                        1 === v.length
                            ? v.css("display", "none")
                            : ((v = this._table.find(
            ...
            (i.prototype._prepareLayoutForPlot = function(e, t) {
                ...
                L
                    ? ((o = $('<tr class="line"/>')),
                      ...
                      n.appendTo(i),
                      this.bindControl(
                          new c(n, _.visible, !0, this.model(), S)
                      ),
                    ...
                    : ((o = $('<tr class="line"/>')),
                      ...
                      n.appendTo(i),
                      (a = $.t(
                          this._study.properties().styles[T].title.value(),
                          {context: "input"}
                      )),
                      this.createLabeledCell(a, n)
                          .appendTo(o)
            ...
            (i.prototype._prepareLayoutForBarsPlot = function(e, t) {
                ...
                y.appendTo(this._table),
                    ...
                    h
                        ? ((a = !0),
                          this._prepareLayoutForPalette(e, t, h, b, C, a))
                        : ((r = $("<td/>")),
                          r.appendTo(y),
                          r.addClass("colorpicker-cell"),
                          (l = g(r)),
                          this.bindControl(
                              new u(l, s.color, !0, this.model(), C)
                          ));
            }),
            (i.prototype._prepareLayoutForCandlesPlot = function(e, t) {
                ...
                this._prepareLayoutForBarsPlot(e, t),
                    ...
                    (d = g(s)),
                    this.bindControl(
                        new u(d, i.wickColor, !0, this.model(), n)
                    );
            }),
            (i.prototype._prepareLayoutForShapesPlot = function(e, t) {
                ...
                L.appendTo(this._table),
                    ...
                    r.appendTo(a),
                    this.bindControl(
                        new h(r, C.plottype, null, !0, this.model(), f)
                    ),
                    (l = $("<td/>")),
                    l.appendTo(L),
                    (p = T()),
                    p.appendTo(l),
                    this.bindControl(
                        new h(p, C.location, null, !0, this.model(), f)
                    ),
                    w
            ...
            (i.prototype._prepareLayoutForCharsPlot = function(e, t) {
                ...
                L.appendTo(this._table),
                    ...
                    this.bindControl(
                        new y(r, C.char, null, !1, this.model(), f)
                    ),
                    (l = $("<td/>")),
                    l.appendTo(L),
                    (p = T()),
            ...
            (i.prototype._findPlotPalette = function(e, t) {
                ...
                if (
                    this._study.isBarColorerPlot(i) ||
                    this._study.isBgColorerPlot(i)
                )
                    ...
                    for (o = 0; o < l.length; o++)
                        if (
                            ...
                            (a = this._study.metaInfo().palettes[l[o].palette]),
                                (r = this._study.properties().palettes[
                                    l[o].palette
                                ]);
                            break;
                        }
            ...
            (i.prototype._prepareStudyPropertiesLayout = function() {
                ...
                return (
                    ...
                    "Compare@tv-basicstudies" === this._study.metaInfo().id &&
                        ...
                        (t = $("<tr>")),
                        t.appendTo(o),
                        $("<td>" + $.t("Override Min Tick") + "</td>").appendTo(
                            t
                        ),
                        $("<td>")
                            .append(e)
                        ...
                        this._pane
                            ...
                            : -1 !==
                              this._pane
                                  ...
                                  .indexOf(this._study)
                                ? (o = "right")
                                : this._pane.isOverlay(this._study) &&
                                  (o = "none")),
                    o &&
                        ((i = this),
                        (n = {
            ...
            (i.prototype._prepareFilledAreaBackground = function(
                e,
                t,
                o,
                i,
                ...
                return (
                    ...
                    (l = g(r)),
                    this.bindControl(
                        new c(a, e, !0, this.model(), n + " visibility")
                    ),
                    this.bindControl(
                        new u(l, t, !0, this.model(), n + " color", o)
                    ),
                    p
                );
            }),
                ...
                for (
                    this._div = $(document.createElement("div")).addClass(
                        ...
                        e &&
                            ...
                            (n = $("<td class='colorpicker-cell'>").appendTo(
                                o
                            )),
                            (a = h(n)),
                            this.bindControl(
        ...
        inherit(i, r),
            ...
            (n.prototype.prepareLayout = function() {
                ...
                (this._table = $(
                    ...
                    this._riskEdit.data(
                        "step",
                        v.getRiskStep(k.riskDisplayMode.value())
                    ),
                    k.riskDisplayMode.subscribe(
                        this,
                        this._onRiskDisplayModeChange
                    ),
                    (m = this.createKeyCombo({
                        percents: $.t("%"),
                        money: $.t("Cash")
                    })),
                    $("<td>")
    ...
    407: function(e, t, o) {
        (function(t) {
            ...
            var n = o(10),
                ...
                g = o(1120).createPriceSourceEditor,
                w = o(38).NumericFormatter;
            inherit(i, a),
                                ...
                                C.options
                                    ...
                                    : "integer" === C.type
                                        ...
                                        : "float" === C.type
                                            ? ((P = [s(C.defval)]),
                                              C.min &&
                                                  (((("BarSetRenko@tv-prostudies" ===
                                                      e.id ||
                                                      "BarSetPnF@tv-prostudies" ===
                                                          e.id) &&
                                                      "boxSize" === C.id) ||
                                                      ("BarSetKagi@tv-prostudies" ===
                                                          e.id &&
                                                          "reversalAmount" ===
                                                              C.id)) &&
                                                      ((B = this._model
                ...
                (i.prototype._prepareSeriesStyleLayout = function(e, o, i, n) {
                    var a,
                        ...
                        ze,
                        Me = $("<tbody>").appendTo(e),
                        He = (this._candlesColorerTbody = $("<tbody>").appendTo(
                            o
                        )),
                        qe = (this._barsColorerTbody = $("<tbody>").appendTo(
                            o
                        )),
                        Ne = (this._haColorerTbody = $("<tbody>").appendTo(o)),
                        Ge = (this._candlesTbody = $("<tbody>").appendTo(i)),
                        Ue = (this._hollowCandlesTbody = $("<tbody>").appendTo(
                            i
                        )),
                    ...
                    nt.addClass("property-wide-select"),
                        ...
                        this._isJapaneseChartsAvailable() &&
                            ...
                            this.prepareLayoutImpl(
                                this.getMetaInfo(
                                    "BarSetPriceBreak@tv-prostudies"
                                ),
                                Xe,
                                n.pbStyle,
                                {valueColspan: 2}
                            ...
                            (Te = this.addColorPickerRow(
                                et,
                                "Projection up bars"
                            )),
                            (_e = this.addColorPickerRow(
                                et,
                                "Projection down bars"
                            )),
                            this.prepareLayoutImpl(
                            ...
                            (Le = this.addColorPickerRow(
                                tt,
                                "Projection up bars"
                            )),
                            (ve = this.addColorPickerRow(
                                tt,
                                "Projection down bars"
                            )),
                            this.prepareLayoutImpl(
        ...
        (i.selectOptions = {type: "option", value: null, html: null}),
            ...
            (i.prototype.init = function() {
                this._tagIsInput()
                    ...
                    : (this.jqObj = r.create(this.data.type, {
                          name: this.data.name
                      }));
            }),
            (i.prototype._eventIsKeyUp = function() {
                return (
                    -1 !== jQuery.inArray(this.data.type, ["text", "textarea"])
                );
            }),
            ...
            (i.prototype._setChecked = function() {
                this.data.selected &&
                    this.jqObj.attr(this._getCheckedAttr(), !0);
            }),
            ...
            (i.isCheckable = function(e) {
                return (
                    -1 !== jQuery.inArray(e, ["checkbox", "radio", "option"])
                );
            }),
            ...
            inherit(i, l),
                ...
                (i.prototype.setScalesOpenTab = function() {
                    this.scalesTab &&
                        this.scalesTab.data(
                            "layout-tab-open",
                            a.TabOpenFrom.Override
                        );
                }),
                (i.prototype.setTmzOpenTab = function() {
                    this.tmzSessTable &&
                        this.tmzSessTable.data(
                            "layout-tab-open",
                            a.TabOpenFrom.Override
                        );
                }),
                (i.prototype.prepareLayout = function() {
                    ...
                    if (
                        (t.enabled("chart_property_page_style") &&
                            ...
                            (O = $('<input type="checkbox">')),
                            (V = this.addLabeledRow(
                                l,
                                $.t("Previous Close Price Line"),
                                O
                            )),
                            $("<td>")
                                .append(O)
                                ...
                                this._pane
                                    ...
                                    : -1 !==
                                      this._pane
                                          ...
                                          .indexOf(this._series)
                                        ? (z = "right")
                                        : this._pane.isOverlay(this._series) &&
                                          (z = "none")),
                            z &&
                                ((M = {
                                    left: $.t("Scale Left"),
                        ...
                        t.enabled("chart_property_page_scales") &&
                            ...
                            (G = $('<input type="checkbox">').change(
                                function() {
                                    this.checked &&
                                        setTimeout(function() {
                                            Vt._model.m_model.invalidate(
                                                new T(T.LIGHT_UPDATE)
                                            );
                                        }, 0);
                                }
                            )),
                            ...
                            (ce = [
                                d(
                                    this._property.paneProperties.topMargin.value()
                                )
                            ]),
                            ce.push(s(25)),
                            ce.push(p(0)),
                            ...
                            (Ce = [
                                d(
                                    this._property.paneProperties.bottomMargin.value()
                                )
                            ]),
                            Ce.push(s(25)),
                            Ce.push(p(0)),
                            ...
                            $(
                                "<td>" +
                                    $.t("bars", {context: "margin"}) +
                                    "</td>"
                            ).appendTo(ge),
                            ($e = [
                                d(this._property.timeScale.rightOffset.value())
                            ]),
                            $e.push(
                                s(~~this._chart.timeScale().maxRightOffset())
                            ),
                            $e.push(p(-200)),
                            this.bindControl(
                                new h(
                            ...
                            (Oe = $('<div class="property-page-column-2">')
                                ...
                                .append(se)),
                            (Ve = $(
                                '<div class="property-page-column-2">'
                            ).append(we)),
                            (P = $("<div>")
                                .css("min-width", "520px")
                                .data("layout-tab", a.TabNames.scales)),
                        ...
                        t.enabled("chart_property_page_background") &&
                            ...
                            (_t = this.addLabeledRow(
                                bt,
                                $.t("Indicator Arguments"),
                                Tt
                            )),
                            (mt = function(e) {
                            ...
                            (St = $(
                                '<div class="property-page-column-1">'
                            ).append(dt)),
                            (x = $("<div>")
                                .css("min-width", "520px")
                ...
                (i.prototype.applyTheme = function(e, t) {
                    this._model._chartWidget._chartWidgetCollection.applyTheme(
                        e,
                        t
                    ),
                        this.loadData();
                        ...
                        this._seriesProperty.style.value())) {
                            case w.STYLE_BARS:
                                this._barsTbody.css(
                                    ...
                                    this._barsColorerTbody.css(
                                        "display",
                                        "table-row-group"
                                    );
                                break;
                            case w.STYLE_CANDLES:
                                this._candlesTbody.css(
                                    "display",
                                    "table-row-group"
                                ),
                                    this._candlesColorerTbody.css(
                                        "display",
                                        "table-row-group"
                                    );
                                break;
                            case w.STYLE_HOLLOW_CANDLES:
                                this._hollowCandlesTbody.css(
                                    "display",
                                    "table-row-group"
                                );
                                break;
                            ...
                            case w.STYLE_HEIKEN_ASHI:
                                this._haTbody.css("display", "table-row-group"),
                                    this._haColorerTbody.css(
                                        "display",
                                        "table-row-group"
                                    );
                                break;
                            case w.STYLE_BASELINE:
                                this._baselineTbody.css(
                                    "display",
                                    "table-row-group"
                                );
                        }
                ...
                (i.prototype.onResoreDefaults = function() {
                    var e,
                        t = this._model.model().properties().paneProperties
                            .topMargin,
                        o = this._model.model().properties().paneProperties
                            .bottomMargin;
                    t.listeners().fire(t),
                        o.listeners().fire(o),
                ...
                (i.prototype.defaultProperties = function() {
                    ...
                    return (
                        setTimeout(function() {
                            ...
                            $.each(["autoScale", "percentage", "log"], function(
                                t,
                                i
                            ) {
                ...
                (i.prototype.createEventsTable = function(e) {
                    ...
                    $("<td>")
                        ...
                        t.enabled("chart_events") &&
                            ...
                            this.bindControl(
                                new y(h, v.visible, !0, this.model(), "", !0)
                            ),
                            this.bindControl(
                                new y(g, v.visible, !0, this.model(), "", !0)
                            ),
                            this.bindControl(
                                new c(
                                    g,
                        ...
                        t.enabled("alerts") &&
                            ...
                            $("<td>")
                                ...
                                .prependTo(z),
                            z.append("<td>"),
                            (E = this._property.alertsProperties.labels
                                .visible),
                            this.bindControl(
                                new c(
                                    B,
                ...
                (i.prototype.createTradingTable = function() {
                    ...
                    return (
                        ...
                        (l = [
                            d(
                                this._property.tradingProperties.lineLength.value()
                            ),
                            s(100),
                            p(0)
                        ]),
        ...
        inherit(i, n),
            (i.prototype.prepareLayout = function() {
                ...
                (this._table = $(
                    ...
                    (t = $(
                        '<div class="property-page-fullwidth-wrapper">'
                    ).append(e)),
                    (o = this.createColorPicker()),
    ...
    775: function(e, t, o) {
        ...
        inherit(i, n),
            ...
            (i.prototype.prepareLayout = function() {
                ...
                for (
                    this._table = $(document.createElement("table")),
                        this._table.addClass(
                            "property-page property-page-unpadded"
                        ),
                        this._table.attr("cellspacing", "0"),
                        this._table.attr("cellpadding", "2"),
            ...
            (i.prototype.addLevelEditor = function(e, t, o) {
                ...
                m.appendTo(this._table),
                    ...
                    e
                        ...
                        : this.createLabeledCell($.t("Trend Line"), n).appendTo(
                              m
                          ),
                    (C = $("<td class='colorpicker-cell'>")),
                    C.appendTo(m),
        ...
        inherit(i, a),
            ...
            (i.prototype.dialogPosition = function(e, t) {
                ...
                if (e && t) {
                    for (
                        o = 0,
                            i = this._linetool._model.paneForSource(
                                this._linetool
                            ),
                            a = h.getChartWidget();
            ...
            (i.prototype.prepareLayout = function() {
                ...
                for (
                    this._table = $(document.createElement("table")),
                        ...
                        this.addLevelEditor(
                            null,
                            this._linetool.properties().median,
                            !1
                        ),
                        e = 0;
                    e <= 8;
            ...
            (n.prototype.dialogPosition = function(e, t) {
                ...
                return (
                    $.each(b.paneWidgets(), function(e, t) {
                        if (t._state === c)
                            return (d = $(t.canvas).offset().top), !1;
                    }),
                    e || (e = {}),
                    (i = e.left),
                    (n = e.top),
        ...
        inherit(i, r),
            ...
            (i.prototype._setStdInput = function(e, t, o) {
                ...
                if (e) {
                    if (
                        ...
                        (y = $('<input id="' + n + '" type="text">').appendTo(
                            w
                        )),
                            !0 !== o &&
            ...
            (i.prototype._setQtyInputs = function(e) {
                ...
                this.bindControl(u),
                    ...
                    (i =
                        (this._study.reportData() &&
                            this._study.reportData().currency) ||
                        "USD"),
                    (n = $(
                        '<option value="cash_per_order">' + i + "</option>"
                    )),
                    (d.options = [
                        $(
                            '<option value="fixed">' +
        ...
        inherit(i, a),
            (i.prototype.prepareLayout = function() {
                ...
                (this._table = $(
                    ...
                    (i =
                        this._study.metaInfo().version <= 46 &&
                        "transparency" in m
                            ? m.transparency
                    ...
                    _.prototype._putStudyDefaultStyles.call(
                        this,
                        this._table,
                        8
                    );
    ...
    1120: function(e, t, o) {
        ...
        function i() {
            var e = $("<select>");
            return (
                $('<option value="open">' + $.t("Open") + "</option>").appendTo(
                    e
                ),
                $('<option value="high">' + $.t("High") + "</option>").appendTo(
                    e
                ),
                $('<option value="low">' + $.t("Low") + "</option>").appendTo(
                    e
                ),
                $(
                ...
                $(
                    '<option value="hl2">' + $.t("(H + L)/2") + "</option>"
                ).appendTo(e),
                $(
