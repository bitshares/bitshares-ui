                ...
                function ThemeNav() {
                    ...
                    nav.reset = function() {
                        ...
                        if (anchor) {
                            try {
                                ...
                                link.closest("li.toctree-l2").addClass(
                                    "current"
                                );
                                link.closest("li.toctree-l3").addClass(
                                    "current"
                                );
                                link.closest("li.toctree-l4").addClass(
                                    "current"
                                );
                            } catch (err) {
                                console.log(
                                    "Error expanding nav for anchor",
                                    err
                                );
                            }
                        }
                    ...
                    nav.onScroll = function() {
                        ...
                        var newWinPosition = this.win.scrollTop(),
                            ...
                            newNavPosition =
                                navPosition +
                                (newWinPosition - this.winPosition);
