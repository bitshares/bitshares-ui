    ...
    _renderCandleStickChart(chartMultiplier, maCalcs, last) {
        ...
        return (
            <Chart
                ...
                height={
                    height *
                    ((chartMultiplier ? 1 : 0.883) - 0.2 * chartMultiplier)
                }
                yExtents={[
                    d => [d.high, d.low],
            ...
            >
                ...
                />
                {indicators.bb ? (
                    <BollingerSeries calculator={calculators.bb} />
                ) : null}
                ...
                let settingInput = hasSetting ? (
                    <div style={{float: "right", clear: "both"}}>
                        ...
                        <input
                            ...
                            onChange={this.props.onChangeIndicatorSetting.bind(
                                null,
                                i
                            )}
                        />
                ...
                <div style={{paddingBottom: 10}}>
                    ...
                    >
                        ...
                        <li
                            className="stat"
                            data-intro={translator.translate(
                                "walkthrough.chart_tool_duration"
                            )}
                        >
                            <span>
                                <span>
                        ...
                        <li
                            className="stat input custom-dropdown"
                            data-intro={translator.translate(
                                "walkthrough.chart_tool_indicators"
                            )}
                        >
                            <div
                        ...
                        <li className="stat input custom-dropdown">
                            <div
                                className="indicators clickable"
                                onClick={this._toggleDropdown.bind(
                                    this,
                                    "settings"
                                )}
