    ...
    render() {
        ...
        let fees = opIds.map((feeIdx) => {
            ...
            for (let key in fee) {
                ...
                let equivalentAmountLTM = amountForLTM ? <EquivalentValueComponent fromAsset="1.3.0" fullPrecision={true} amount={amountForLTM} toAsset={preferredUnit}/> : feeTypes["_none"];
                let title = null;
