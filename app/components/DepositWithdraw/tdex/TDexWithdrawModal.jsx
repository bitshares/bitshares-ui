...
class TDexWithdrawModal extends React.Component {
    ...
    render() {
        ...
        if (this.state.options_is_valid) {
            options =
                <div className={!storedAddress.length ? "tdex-disabled-options" : "tdex-options"}>
        ...
        return (<form className="grid-block vertical full-width-content">
                <div className="grid-container">
                    ...
                    <div className="content-block">
                        ...
                        {this.state.minAmountError ? <p className="has-error no-margin" style={{paddingTop: 10}}><Translate content="gateway.tdex.min_amount_error" /></p>:null}
                        <p className="no-margin" style={{paddingTop: 10}}><b><Translate content="gateway.tdex.min_amount" minAmount={utils.format_number(this.props.min_amount / utils.get_asset_precision(this.props.asset_precision), this.props.asset_precision, false)} symbol={this.props.output_coin_symbol}/></b></p>
                    </div>
                    ...
                    <div className="content-block">
                        ...
                        <div className="tdex-select-dropdown">
...
export default BindToChainState(TDexWithdrawModal, {keep_updating:true});
