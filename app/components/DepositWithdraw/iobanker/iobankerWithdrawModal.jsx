...
import {validateAddress, WithdrawAddresses} from "common/iobankerMethods";
...
class iobankerWithdrawModal extends React.Component {
    static propTypes = {
                    ...
                    <div className="content-block">
                        ...
                        {this.state.minAmountError ? (
                            <p
                                ...
                                style={{paddingTop: 10}}
                            >
                                <Translate content="gateway.iobanker.min_amount_error" />
                            </p>
                        ) : null}
...
export default BindToChainState(iobankerWithdrawModal, {keep_updating: true});
