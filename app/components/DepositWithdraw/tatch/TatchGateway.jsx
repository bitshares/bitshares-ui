...
import TatchGatewayDepositRequest from "./TatchGatewayDepositRequest";
...
class TatchGateway extends React.Component {
    constructor(props) {
        super();
                ...
                {!coin ? null : (
                    <div>
                        <div style={{marginBottom: 15}}>
                            ...
                            <div>
                                <Translate content="gateway.tatch.support_block" />
                                <br />
                                <br />
                                <a
                                    href={
