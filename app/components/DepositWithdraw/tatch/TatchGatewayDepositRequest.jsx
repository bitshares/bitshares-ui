...
import {requestDepositAddress, getDepositAddress} from "common/TatchMethods";
...
class TatchGatewayDepositRequest extends React.Component {
    static propTypes = {
...
export default BindToChainState(TatchGatewayDepositRequest);
