...
import CryptosudoGatewayDepositRequest from "./CryptosudoGatewayDepositRequest";
...
class CryptosudoGateway extends React.Component {
    constructor(props) {
        super();
                ...
                {!coin ? null : (
                    <div>
                        <div style={{marginBottom: 15}}>
                            <CryptosudoGatewayDepositRequest
                            ...
                            <div>
                                <Translate content="gateway.cryptosudo.support_block" />
                                <br />
                                <br />
                                <a
                                    href={
