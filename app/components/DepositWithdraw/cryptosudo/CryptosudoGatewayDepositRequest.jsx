...
import CryptosudoWithdrawModal from "./CryptosudoWithdrawModal";
import AccountBalance from "../../Account/AccountBalance";
import AssetName from "components/Utility/AssetName";
import LinkToAccountById from "components/Utility/LinkToAccountById";
import {requestDepositAddress, getDepositAddress} from "common/CryptosudoMethods";
...
class CryptosudoGatewayDepositRequest extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            url: props.url || cryptosudoAPIs.BASE,
            loading: false,
...
export default BindToChainState(CryptosudoGatewayDepositRequest);
