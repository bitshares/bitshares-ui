...
class CryptosudoDepositAddressCache {
    constructor() {
        this.current_cryptosudo_address_cache_version_string = "2";
    }
    ...
    getIndexForDepositKeyInExchange(
        ...
        let args = [
            this.current_cryptosudo_address_cache_version_string,
            account_name,
            input_coin_type,
            output_coin_type
        ];
...
} // CryptosudoDepositAddressCache

export default CryptosudoDepositAddressCache;
