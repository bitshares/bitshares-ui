...
class BitsparkDepositAddressCache {
    constructor() {
        this.current_bitspark_address_cache_version_string = "2";
    }
    ...
    getIndexForDepositKeyInExchange(
        ...
        let args = [
            this.current_bitspark_address_cache_version_string,
            account_name,
            input_coin_type,
            output_coin_type
        ];
...
} // BitsparkDepositAddressCache

export default BitsparkDepositAddressCache;
