...
class TDexDepositAddressCache {
    constructor()
    {
        // increment this to force generating new addresses for all mappings
        this.current_tdex_address_cache_version_string = "1";
    }

    getIndexForDepositKeyInExchange(account_name, input_coin_type, output_coin_type)
    {
        let args = [this.current_tdex_address_cache_version_string, account_name, input_coin_type, output_coin_type];
...
}; // TDexDepositAddressCache

export default TDexDepositAddressCache;
