...
Types.public_key = {
    toPublic(object){
        ...
        return object == null ? object :
            object.Q ? object : PublicKey.fromPublicKeyString(object)
    },
    fromByteBuffer(b){
    ...
    toObject(object, debug = {}){
        if (debug.use_default && object === undefined) {
            return chain_config.address_prefix + "859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM";
        }
        v.required(object);
        return object.toString()
    },
