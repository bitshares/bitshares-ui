 module.exports = {
    ...
    operation: {
        ...
        reg_account: "{registrar} adlı hesap {new_account} adlı hesabın kaydını yaptı",
        transfer: "{from}adlı hesap {to} adlı hesaba {amount} gönderdi",
        ...
        fill_order: "{account} {price} değerinde {received} satın aldı",
        vesting_balance_withdraw: "{account}  {amount} değerinde hak edilen bakiyesini çekti ",
        balance_claim: "{account} {amount} değerinde bakiyeyi talep etti",
        publish_feed: "{account} {price} fiyatını duyurdu",
        ...
        limit_order_sell: "{account} {price} fiyatı üzerinden {amount} miktarında satış emri verdi ",
        limit_order_buy: "{account} {price} fiyatı üzerinden {amount} miktarında alış emri verdi ",
        limit_order_cancel: "{account} #%(order)s numaralı emri iptal etti",
        ...
        asset_settle: "{account} {amount} değeinde hesaplaşmayı talep etti",
        asset_global_settle: "{account} {asset} adlı aktifin {price} fiyatı üzerinden genel olarak hesaplaşılmasını talep etti ",
        witness_create: "{account} adlı hesap tanık olmak üzere yükseltildi",
