        ...
        trx.operations.forEach((op, opIndex) => {
            switch (op[0]) { // For a list of trx types, see chain_types.coffee
                ...
                case 0: // Normal transfer
                    ...
                    let missing = this.getAssets([op[1].amount.asset_id, op[1].fee.asset_id]);
                    info.push(
                        <OperationTable key={opIndex} index={opIndex} color="success" type={op[0]}>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{!missing[1] ? <FormattedAsset amount={op[1].fee.amount} asset={assets.get(op[1].fee.asset_id)} /> : null}</td>
                            </tr>
                        </OperationTable>
                    );
                    break;
                ...
                case 1: // limit_order_create
                    ...
                    info.push(
                        <OperationTable key={opIndex} index={opIndex} color="warning" type={op[0]}>
                                <tr>
                                ...
                                <tr>
                                    <td><Translate component="span" content="transfer.fee" />:</td>
                                    <td><FormattedAsset amount={op[1].fee.amount} asset={assets.get(op[1].fee.asset_id)} /></td>
                                </tr>
                        </OperationTable>
                    );
                    break;
                ...
                case 3: // limit_order_cancel
                    info.push(
                        <OperationTable key={opIndex} index={opIndex} color="default" type={op[0]}>
                                <tr>
