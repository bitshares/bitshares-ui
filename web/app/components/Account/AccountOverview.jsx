    ...
    _renderBalances(balanceList) {
        ...
        balanceList.forEach( balance => {
            ...
            if (asset) {
                ...
                marketLink = asset.get("id") !== "1.3.0" ? <a href={`${__ELECTRON__ ? "#" : ""}/market/${asset.get("symbol")}_${preferredMarket}`}><AssetName name={asset.get("symbol")} /> : <AssetName name={preferredMarket} /></a> : null;
                ...
                assetInfoLinks = (
                <ul>
                    <li><a href={`${__ELECTRON__ ? "#" : ""}/asset/${asset.get("symbol")}`}><Translate content="account.asset_details"/></a></li>
                    <li>{marketLink}</li>
